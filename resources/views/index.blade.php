...
@section('content')
                        ...
                        <div class="slider-left-content">
                            ...
                            <div class="slider-video-link">
                                <a href="{{ $titles->hero_button_url ?? '' }}" class="popup">
                                    <span class="iconify" data-icon="ant-design:play-circle-filled"
                                        data-inline="false"></span> {{ $titles->hero_btn_title ?? '' }}
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="payment-calculation">
                            <div id="input" class="input-section position-relative">
                                ...
                                <div class="money-currency">
                                    <a href="#"><span><img src="{{ asset('frontend/assets/img/flag/1.png') }}"
                                                alt=""> <span> {{ __('USD') }}</span></span></a>
                                </div>
                            </div>
                            <div class="calculation-menu">
                                <nav>
                                    <ul class="calc">
                                                ...
                                                <span class="calculation-payment-select">
                                                    <select id="withdrawMethod">
                                                        @forelse ($withdrawMethod as $method)
                                                            <option data-charge-type ="{{ $method->charge_type }}"
                                                        ...
                                                        @empty
                                                            <option data-charge-type ="0" data-min="0" data-max="0"
                                                                data-fixed-charge="0" data-percent-charge=0 value="0">
                                                                --</option>
                                                        @endforelse
                                        ...
                                        <li>
                                            <span class="icon-area"><span class="iconify" data-icon="eva:close-outline"
                                                    data-inline="false"></span></span>
                                            <span class="calculation-divison">
                                                <div class="charge text-rate">
                                                    <span id="rate"></span>
                                                    <span class="iconify" data-icon="vaadin:trending-up"
                            ...
                            <div class="input-section recepiet">
                                ...
                                <div class="money-currency">
                                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false"><span><img
                                                id="country_flag" src="" alt=""> <span id="currency_name">
                                            </span>&nbsp <span class="iconify" data-icon="dashicons:arrow-down-alt2"
                        ...
                        <div class="col-lg-12">
                            <div class="single-service">
                                ...
                                <div class="service-action">
                                    <a href="{{ route('service.show', $data->slug) }}">{{ __('Learn More') }} <span
                                            class="iconify" data-icon="bi:arrow-right" data-inline="false"></span></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
    ...
    <section>
        ...
        @endphp
        <div class="counter-area mb-100"
            style="background-image: url('{{ asset('frontend/assets/img/pattern.png') }}');">
            <div class="container">
                        ...
                        <div class="col-lg-3">
                            <div class="single-sponser text-center">
                                ...
                                <div class="sponser-social-links">
                                    <nav>
                                        <ul>
                                            <li><a href="{{ $meta_data->facebook_link }}"><span class="iconify"
                                                        data-icon="brandico:facebook" data-inline="false"></span></a></li>
                                            <li><a href="{{ $meta_data->twitter_link }}"><span class="iconify"
                                                        data-icon="ant-design:twitter-outlined"
                                                        data-inline="false"></span></a></li>
                                            <li><a href="{{ $meta_data->linkedin_link }}"><span class="iconify"
                    ...
                    @foreach ($latest_news as $data)
                        <div class="col-lg-4">
                            <div class="single-news">
                                <div class="news-img">
                                    <a href="{{ route('blog.show', $data->slug) }}"><img class="img-fluid"
                                            src="{{ asset($data->thum_image->value) }}" alt=""></a>
                                </div>
                                <div class="news-content">
                                    ...
                                    <div class="news-action">
                                        <a href="{{ route('blog.show', $data->slug) }}">{{ __('Learn More') }} <span
                                                class="iconify" data-icon="bi:arrow-right"
